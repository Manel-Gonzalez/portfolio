...
const InformationBanner = () => {
  ...
  return (
    <div
      className="flex justify-between flex-row w-100 bg-white mx-4 rounded-md shadow-lg shadow-gray-500/65 border border-slate-200 dark:bg-dark-background dark:text-dark-text
"
    >
